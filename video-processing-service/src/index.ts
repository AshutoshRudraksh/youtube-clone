...
const  port = process.env.PORT || 3000; // "process.env.PORT " : this is standard way to decalre the port at the run time
...
// note -- the path of the video matter should not be in the src dir
